...
import 'package:cropp/SignUp.dart';
...
void main() => runApp(
  MaterialApp(
    ...
    routes: <String,WidgetBuilder>{
      '/landingPage':(BuildContext context)=> new SignupPage(),
      '/signup':(BuildContext context)=> new SignupPage(),
      '/Explore':(BuildContext context)=> new ExPage(), 
      '/CropPred':(BuildContext context)=> new MyCrop(),
